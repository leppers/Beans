...
public partial class PIC : System.Web.UI.Page
{
    ...
    protected void btnCreateInventory_Click(object sender, EventArgs e)
    {
        lblDateTime.Text = DateTime.Now.ToString(); 
        lblEmployeeName.Text = ddlEmployeeID.Text;
    ...
    protected void btnAddItem_Click(object sender, EventArgs e)
    {
        ...
        LineItemRepeater.DataBind();
        LineItemGridView.DataSource = newinventoryItem;
    ...
    protected void btnFinish_Click(object sender, EventArgs e)
    {
        ...
        if (newinventoryItem.Count >= 1)
        {
            ...
            int EmployeeID = int.Parse(lblEmployeeName.Text);
            DateTime datetime = DateTime.Parse(lblDateTime.Text);
    ...
    {
        Server.Transfer("print_receipt.aspx?receiptID=" + hfInventoryID.Value);
    }
