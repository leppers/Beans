<%@ Page Title="Group Scheduling" Language="C#" MasterPageFile="~/MasterPages/Volunteer.master" AutoEventWireup="true" CodeFile="GroupScheduling.aspx.cs" Inherits="volunteerTest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Direction="NotSet" Visible="true">
        ...
        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" 
            ...
            onselectionchanged="Calendar1_SelectionChanged" Width="496px">
