...
[System.Data.Linq.Mapping.DatabaseAttribute(Name="Beans_DB_v5")]
...
public partial class Entity : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_Entity_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	...
	[Column(Storage="_Entity_Organization_Name", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_Contact_FName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
	...
	[Column(Storage="_Entity_Contact_MName", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_Contact_LName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
	...
	[Column(Storage="_Entity_Address1", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_Address2", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_City", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_State", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_ZipCode", DbType="VarChar(5)")]
	...
	[Column(Storage="_Entity_Email", DbType="VarChar(50)")]
	...
	[Column(Storage="_Entity_Phone", DbType="VarChar(10)")]
	...
	[Column(Storage="_Entity_Type", DbType="VarChar(15) NOT NULL", CanBeNull=false)]
	...
	[Column(Storage="_Entity_Support_Type", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
	...
	[Association(Name="Entity_Volunteer", Storage="_Volunteers", ThisKey="Entity_ID", OtherKey="Entity_ID")]
...
public partial class Volunteer : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_Entity_ID", DbType="Int NOT NULL", IsPrimaryKey=true)]
	public int Entity_ID
	{
		get
		{
	...
	[Column(Storage="_Shift_ID", DbType="Int NOT NULL", IsPrimaryKey=true)]
	public int Shift_ID
	{
		get
		{
	...
	[Column(Storage="_Clock_In", DbType="Time")]
	...
	[Column(Storage="_Clock_Out", DbType="Time")]
	...
	[Column(Storage="_Volunteers_Scheduled", DbType="Int")]
	...
	[Column(Storage="_Volunteers_Worked", DbType="Int")]
	...
	[Column(Storage="_Community_Service", DbType="Binary(1)", UpdateCheck=UpdateCheck.Never)]
	...
	[Column(Storage="_Volunteer_Comments", DbType="VarChar(50)")]
	...
	[Column(Storage="_is_client", DbType="Binary(1)", UpdateCheck=UpdateCheck.Never)]
	...
	[Association(Name="Entity_Volunteer", Storage="_Entity", ThisKey="Entity_ID", OtherKey="Entity_ID", IsForeignKey=true)]
	...
	[Association(Name="Shift_Volunteer", Storage="_Shift", ThisKey="Shift_ID", OtherKey="Shift_ID", IsForeignKey=true)]
	public Shift Shift
	{
		get
		{
...
public partial class Shift : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_Shift_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
	public int Shift_ID
	{
		get
		{
	...
	[Column(Storage="_Shift_Name", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
	...
	[Column(Storage="_Shift_Date", DbType="DateTime")]
	...
	[Column(Storage="_Shift_Description", DbType="VarChar(50)")]
	...
	[Association(Name="Shift_Volunteer", Storage="_Volunteers", ThisKey="Shift_ID", OtherKey="Shift_ID")]
	public EntitySet<Volunteer> Volunteers
	{
		get
		{
